...
# -*- coding: utf-8 -*-
# @Author: yanzhipeng
# @Date:   2019-12-03 14:46:43
# @Last Modified by:   yanzhipeng
# @Last Modified time: 2019-12-03 15:50:59
...
def auth():
    ...
    # 第一步：输入账号、密码，然后点击登陆
    input_name = driver.find_element_by_id('LoginName')  # 找到输入用户名的框
    input_pwd = driver.find_element_by_id('Password')  # 找到输入密码的框
    input_button = driver.find_element_by_id('submitBtn')  # 找到按钮
    input_name.send_keys("yata818")  # 博客园的账号
    input_pwd.send_keys("5201314qq")  # 博客园的密码
